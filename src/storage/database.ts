...
export class JsonDatabase {
  ...
  private defaultState(config: PersistedConfig, _historyLimit: number): PersistedState {
    return { config, outageStartedAt: null, outageAlertMessageId: null, currentStatus: 'HEALTHY', consecutiveFailures: 0, consecutiveSuccesses: 0, lastCheck: null, lastSuccessfulAt: null, lastFailedAt: null, checks: 0, successes: 0, failures: 0, rateLimits: 0, apiErrors: 0, deprecated: 0, responseTimeTotalMs: 0, history: [] };
  }
